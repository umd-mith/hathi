...
download the metadata for a batch of volume identifiers. See the `BibDownloader`
...
supported by a grant from the [HathiTrust Research Center](http://www.hathitrust.org/htrc)'s
